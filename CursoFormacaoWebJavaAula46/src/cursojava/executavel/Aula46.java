...
public class Aula46 {
	...
	/* Aula 46 - Simples Validação de Permissão de Acesso */
	...
	public static void main(String[] args) {
		...
		//Método HashMap também é uma lista que dentro dela temos uma chave que identifica uma sequencia de valores também.
